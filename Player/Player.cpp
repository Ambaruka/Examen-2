...
Player::Player( char* name, int health, int attack, int defense, int speed, int level) : Character(name, health, attack, defense,speed, level, true) {
    experience = 0;
    level = 1;
}
...
Player* Player::unserialize(char* _buffer) {
    ...
    return new Player(_name, _health, _attack, _defense, _speed, _experience, _level);
}